...
import { Sparkles, Clock, Zap, Target, Flame, Calendar } from "lucide-react";
        ...
        <div className="space-y-3 max-w-2xl">
          ...
          <div>
            ...
            <p className="text-sm sm:text-base text-dark-muted mt-1.5 leading-relaxed font-medium">
              Discover historical trends, measure productivity metrics, and analyze your long-term learning performance over time.
            </p>
          </div>
        </div>

        {/* Right Column: Key Stats & Date Range Selector */}
