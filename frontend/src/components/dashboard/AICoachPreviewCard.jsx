...
const ACTION_CONFIG = {
  0: { label: "Continue Skill Roadmap", route: "/skills", icon: BookOpen },
...
function AICoachPreviewCard() {
  ...
  const handleAccept = async () => {
    try {
      setFeedbackMessage("Recommendation accepted. Routing to activity...");
      await respondToRecommendation(eventId, "accepted", "cta_click", actionCfg.route).catch(() => null);
      setTimeout(() => {
